...
public class Prescripcion implements Serializable {
    ...
    public Prescripcion(String idPrescripcion) {
        this.idPrescripcion = idPrescripcion;
    }

    public Prescripcion(String idPrescripcion, Integer idEstatusPrescripcion, Date updateFecha, String updateIdUsuario) {
        this.idPrescripcion = idPrescripcion;
    ...
    public int hashCode() {
        ...
        hash = 53 * hash + Objects.hashCode(this.fechaFirma);
        hash = 53 * hash + Objects.hashCode(this.tipoPrescripcion);
        hash = 53 * hash + Objects.hashCode(this.tipoConsulta);
        hash = 53 * hash + Objects.hashCode(this.idMedico);
        hash = 53 * hash + (this.recurrente ? 1 : 0);
        hash = 53 * hash + Objects.hashCode(this.comentarios);
        hash = 53 * hash + Objects.hashCode(this.idEstatusPrescripcion);
        hash = 53 * hash + Objects.hashCode(this.idEstatusGabinete);
        hash = 53 * hash + Objects.hashCode(this.resurtimiento);
        hash = 53 * hash + Objects.hashCode(this.origenDestino);
        ...
        hash = 53 * hash + Objects.hashCode(this.idTipoSolucion);
        hash = 53 * hash + Objects.hashCode(this.idViaAdministracion);
        hash = 53 * hash + Objects.hashCode(this.idSigno);
        hash = 53 * hash + Objects.hashCode(this.idProtocolo);
        hash = 53 * hash + Objects.hashCode(this.idDiagnostico);
        hash = 53 * hash + Objects.hashCode(this.idPacienteUbicacion);
        hash = 53 * hash + Objects.hashCode(this.insumosList);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.recurrente != other.recurrente) {
            return false;
        }
        ...
        if (!Objects.equals(this.resurtimiento, other.resurtimiento)) {
            return false;
        }
        if (!Objects.equals(this.origenDestino, other.origenDestino)) {
            return false;
        }
