 ...
 * @author hramirez
 */
public class JobEntregaDimesa extends QuartzJobBean {
    ...
    protected void executeInternal(JobExecutionContext jec) throws JobExecutionException {
        LOGGER.trace("mx.mc.quartz.JobEntregaDimesa.executeInternal()");
    ...
    private void ejecutaJob() {
        LOGGER.trace("mx.mc.quartz.JobEntregaDimesa.ejecuta()");
        try {
            consultaEntrega();
    ...
    public void consultaEntrega() {
        LOGGER.trace("mx.mc.quartz.JobEntregaDimesa.consultaEntrega()");
