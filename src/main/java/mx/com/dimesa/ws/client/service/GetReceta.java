 ...
 *         &lt;element name="recetas" type="{http://schemas.datacontract.org/2004/07/RecetaSAFWSAppCore.Composites}ArrayOfReceta" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetReceta")
public class GetReceta {
    ...
    @XmlElementRef(name = "recetas", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<ArrayOfReceta> recetas;
     ...
     *     
     */
    public JAXBElement<ArrayOfReceta> getRecetas() {
        return recetas;
    }
     ...
     *     
     */
    public void setRecetas(JAXBElement<ArrayOfReceta> value) {
        this.recetas = value;
    }
